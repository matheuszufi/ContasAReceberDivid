...
export default function Dashboard() {
  ...
  // Filtro do card "Mapa de Imóveis": quais imóveis aparecem no mapa
  ...
  // ---- Filtro de ocupação do card "Mapa de Imóveis" ----
  ...
  const imoveisMapaFiltrados = useMemo(() => {
    ...
    if (mapaFiltroOcupacao === 'ocupados') return comFlag.filter(im => im.ocupado)
    if (mapaFiltroOcupacao === 'desocupados') return comFlag.filter(im => !im.ocupado)
    return comFlag
  }, [imoveis, imovelIdsOcupados, mapaFiltroOcupacao])

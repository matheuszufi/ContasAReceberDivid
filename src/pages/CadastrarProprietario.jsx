...
export default function CadastrarProprietario() {
  ...
  // administrativa e o repasse do mês selecionado.
  //
  // A base da taxa administrativa (baseTotal) SÓ inclui os componentes marcados no checkbox
  // "Incidência da Taxa Adm" daquele imóvel (aluguel / serviços / iptu / condomínio) — ver
  // itensIncidencia abaixo. Serviços, IPTU e condomínio só entram na base (e portanto só geram
  // taxa adm sobre eles) se estiverem explicitamente assinalados em v.incidenciaTaxaAdm. Se
  // nenhum item estiver marcado, a base é zero (sem fallback automático).
  //
  // A taxa de contrato só é descontada no mês em que o inquilino atual entrou (dataEntrada),
  // nunca nos meses seguintes, e continua calculada sobre o aluguel (não sobre a base da taxa adm).
  //

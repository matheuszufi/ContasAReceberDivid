...
export default function Inadimplentes() {
  ...
  // duplicar os mapas de labels em outras telas. Também guarda o valor do débito e o mês de
  // referência no momento da alteração, para exibição direta no card do Dashboard.
  const registrarHistorico = async (d, campo, campoLabel, valorAnteriorKey, valorAnteriorLabel, valorNovoKey, valorNovoLabel) => {
    try {
      await push(ref(db, 'historicoAlteracoes'), {
        ...
        valorDebito: d.valorTotal || d.valorOriginal || 0,
        mesReferencia: getMonth(d) || null,
        campo,
        campoLabel,

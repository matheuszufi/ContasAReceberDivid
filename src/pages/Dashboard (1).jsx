                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <div className="flex cursor-default items-center justify-between gap-2">
                        ...
                        <span className="shrink-0 font-medium">{fmtMoney(selectedMonthTotals.acionado)}</span>
                      </div>
                    </TooltipTrigger>
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <div className="flex cursor-default items-center justify-between gap-2">
                        ...
                        <span className="shrink-0 font-medium">{fmtMoney(selectedMonthTotals.juridico)}</span>
                      </div>
                    </TooltipTrigger>
